...
exports.getAll = () =>
  db.query(
    "SELECT g.created_at, g.organisation, g.reference, g.title, g.disbanded_at, g.open, g.visible, a.email FROM groups AS g INNER JOIN accounts AS a ON g.creator = a.id"
  );
